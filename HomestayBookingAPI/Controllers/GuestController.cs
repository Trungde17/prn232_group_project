...
public class GuestController : ControllerBase
{
    ...
    {
        // Xây predicate động dựa trên DTO
        Expression<Func<Homestay, bool>> predicate = h =>
            ...
            (!search.WardId.HasValue || h.WardId == search.WardId.Value);

        var homestays = await _homestayRepository.FindAsync(predicate);
    ...
    {
        var homestay = await _homestayRepository.GetAsync(id);
